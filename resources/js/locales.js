...
window.DT_LOCALES["fr"] =
    {
        ...
        SHOWING_TO: "lignes {FROM} de {TO} a {SIZE}",
        GOTO_FIRST: "revenir à la page 1",
        GOTO_PREV: "revenir à la page précédente",
        GOTO_PAGE: "aller à la page {NUM}",
        GOTO_NEXT: "aller à la prochaine page",
        GOTO_LAST: "aller à la dernière page",
